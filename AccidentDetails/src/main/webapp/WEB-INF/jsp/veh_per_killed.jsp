...
<%@ page import="com.google.gson.JsonObject"%>
 ...
 <%
	...
	ResultSet rs = stmt.executeQuery("select Persons_killed from vehiclewise order by Persons_killed DESC");
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title: {
		text: "No. of persons killed in India based on the type of vehicle"
	},
	data: [{
		type: "bar",
