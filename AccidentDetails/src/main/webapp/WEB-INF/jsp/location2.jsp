...
<%@ page import="com.google.gson.JsonObject"%>
 ...
 <%
	...
	ResultSet rs = stmt.executeQuery("select Total_Number_of_Persons_Injured_in_Road_Accidents_during_2015 from accidents order by Total_Number_of_Persons_Injured_in_Road_Accidents_during_2015 DESC");
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title: {
		text: "Total_Number_of_Persons_Injured_in_Road_Accidents_during_2015"
	},
	data: [{
		type: "pie",
