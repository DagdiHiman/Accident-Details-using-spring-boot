...
<%@ page import="com.google.gson.JsonObject"%>
 ...
 <%
	...
	ResultSet rs = stmt.executeQuery("select Persons_injured from vehiclewise order by Persons_injured DESC");
	...
	ResultSet rs1 = stmt.executeQuery("select Vehicletype from vehiclewise");
	while(rs1.next()){
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title: {
		text: "No. of persons injured in India based on the type of vehicle"
	},
	data: [{
		type: "doughnut",
