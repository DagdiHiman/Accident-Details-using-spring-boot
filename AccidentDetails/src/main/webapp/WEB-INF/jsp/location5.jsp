...
<%@ page import="com.google.gson.JsonObject"%>
 ...
 <%
	...
	ResultSet rs = stmt.executeQuery("select of_Persons_injured_in_Road_Accidents_per_10_000_Vehicles_2014 from accidents order by of_Persons_injured_in_Road_Accidents_per_10_000_Vehicles_2014 DESC");
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title: {
		text: "Persons injured in Road Accidents per 10,000 Vehicles 2014"
	},
	data: [{
		type: "area",
