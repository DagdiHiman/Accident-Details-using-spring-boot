...
<%@ page import="com.google.gson.JsonObject"%>
 ...
 <%
	...
	ResultSet rs = stmt.executeQuery("select No_of_Accidents from vehiclewise order by No_of_Accidents DESC");
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title: {
		text: "No. of Accidents in India based on the type of vehicle"
	},
	data: [{
		type: "waterfall",
